function downloadClient() 
{
	...
	switch (platform) 
	{
		case "Win32": 
		{
			window.location.href = "https://github.com/MayoDevStudios/NekoPlayer/releases/latest/download/NekoPlayer-win-Setup.exe";
			break;
		}
		case "Linux x86_64": 
		{
			window.location.href = "https://github.com/MayoDevStudios/NekoPlayer/releases/latest/download/NekoPlayer-linux-x64.AppImage";
			break;
		}
	}
}
...
getLatestRelease('MayoDevStudios', 'NekoPlayer');
